<?php 
		...
		session_start();
		  ...
		  if (isset($_POST['signup'])) {
			...
			if (count($errors) == 0) {
			    $pword = md5($pword);
			    $sql = "INSERT INTO credentials (fullname, age, birthday, email, tof, username, password, confirmpass, group_id)
			    VALUES ('$fname', '$age', '$bday', '$email', '$tof', '$uname', '$pword', '$cpass', '$group_id')";
