  ...
  if (isset($_POST['btn_post'])) {
        ...
        $posted_by = $_POST['posted_by'];
            ...
            $sql = "INSERT INTO dashboard_podcasts (title, description, date_posted, picture, posted_by, video)
            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <?php endif ?>
                  <form class="forms-sample" action="podcasts.php" method="POST" enctype="multipart/form-data">
                    ...
                    <h4 class="card-title">Podcasts:</h4>
                      ...
                      <div class="form-group">
                          <label for="exampleInputName1">Upload Video/Audio</label>
                      ...
                      <input type="submit" class="btn btn-success mr-2" name="btn_post" value="POST PODCASTS">
                  </form>
                </div>
              </div>
            </div>
              ...
              <div class="card">
                <div class="card-body">
                  <form class="forms-sample" method="POST" enctype="multipart/form-data">
                    <h4 class="card-title">ALL VIDEOS/AUDIO</h4>
                    <?php
                      include '../credentials/connection.php';
                      $client = $_SESSION['user']['fullname'];
                      $sql = mysqli_query($conn, "SELECT * FROM dashboard_podcasts WHERE posted_by = '$client'");
                      while ($row = mysqli_fetch_array($sql)) {
                        $id = $row['id'];
                        $video = $row['video'];
                        
                        echo "<a style = 'text-decoration: none;' href='podcasts_watch.php?id=$id'>$video</a><br>";
                      }
                    ?>
                  </form>
                </div>
                      ...
                      <table id="newstable" class="table table-striped table-bordered">
                          ...
                          <tbody>
                            <?php
                              include '../credentials/connection.php';
                              $client = $_SESSION['user']['fullname'];
                              $table = mysqli_query($conn, "SELECT * FROM dashboard_podcasts WHERE posted_by = '$client'");
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
              ...
              <input type="hidden" id="podcastsId" class="form-control">
              <div class="form-group">
  ...
  <script type="text/javascript" src="podcasts_edit.js"></script>
