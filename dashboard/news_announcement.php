  ...
  if (isset($_POST['btn_post'])) {
        ...
        $posted_by = $_POST['posted_by'];
            ...
            $sql = "INSERT INTO dashboard_newsannouncement (title, description, date_posted, picture, posted_by)
            VALUES ('$title', '$description', '$dpost', '$image', '$posted_by')";
            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <?php endif ?>
                  <form class="forms-sample" action="news_announcement.php" method="POST" enctype="multipart/form-data">
                    ...
                    <h4 class="card-title">News & Announcement:</h4>
                      ...
                      <input type="submit" class="btn btn-success mr-2" name="btn_post" value="POST ANNOUNCEMENT">
                  </form>
                </div>
              </div>
            </div>
                      ...
                      <table id="newstable" class="table table-striped table-bordered">
                          ...
                          <tbody>
                            <?php
                              ...
                              $table = mysqli_query($conn, "SELECT * FROM dashboard_newsannouncement WHERE posted_by = '$client'");
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
              ...
              <input type="hidden" id="newsId" class="form-control">
              <div class="form-group">
  ...
  <script type="text/javascript" src="news_announcementedit.js"></script>
  ...
  // for delete js
    function deleteData(id) {
      if(confirm('Are you sure want to delete this Announcement?')){
        $.ajax({
          type:'POST',
          url:'news_announcementdelete.php',
          data:{delete_id:id},
