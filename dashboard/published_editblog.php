                  ...
                  <form class="forms-sample" action="published_yourblog.php" method="POST"  enctype="multipart/form-data">
                    <h4 class="card-title">Edit Blogs:</h4>
                      <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control" id="exampleInputEmail3" value ="<?php echo $title; ?>">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="article" class="form-control" id="exampleInputCity1" value="<?php echo $article; ?>">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword4">Date Posted</label>
                        <input type="date" name="dpost" class="form-control" id="exampleInputPassword4" value="<?php echo $dpost; ?>">
                      </div>
                      <div class="form-group">
                      ...
                      <input type="submit" class="btn btn-success mr-2" name="btn_edit" value="SUBMIT EDITED BLOG">
                  </form>
                </div>
              </div>
            </div>
