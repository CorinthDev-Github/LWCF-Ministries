                ...
                <form method="POST" id="comment_form">
                  ...
                  if (isset($_GET['id'])) {
                    ...
                    <div class="form-group">
                      <input type="hidden" id = "type_concern" name = "type_concern" class="form-control" value="encouragement concern" readonly>
                      <label>Name:</label>
                      <input type="text" value="<?php echo $row['name']; ?>" id = "name_enc" name = "name_enc" class="form-control" readonly>
                    </div>
                    <div class="form-group">
                      <label>Prayer Concern:</label>
                      <textarea type="text" class="form-control" rows="5" id = "concern_enc" name = "concern_enc" readonly><?php echo $row['encouragement_concern']; ?></textarea>
                    </div>
                      <div class="form-group">
                ...
                <div class="card-body">
                  ...
                  <form>
                    <?php 
                      ...
                      $query = mysqli_query($conn, "SELECT * FROM dashboard_commentenc WHERE type_concern = 'encouragement concern' ");
