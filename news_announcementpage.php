      ...
      <div class="container">
        ...
        <div class="row">
          <?php
            ...
            $query = mysqli_query($conn, "SELECT * FROM dashboard_newsannouncement ORDER BY id DESC");
            ...
            <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s"><br>
             <a href="news_announcementview.php?id=<?php echo $row['id']; ?>">
              <div class="card">
                <img class="image" src="dashboard/news_upload/<?php echo $row['picture']; ?>" style="width: 100%; height: 200px;" alt="Avatar">
