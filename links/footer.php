  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="ion-ios-arrow-right"></i> <a href="podcasts.php">Podcasts</a></li>
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <div class="social-links">
              ...
              <a href="https://www.facebook.com/lwcfcamp2018/" target="_blank" class="facebook"><i class="fa fa-facebook"></i></a>
    ...
    <div class="container">
      <div class="copyright">
        <strong>CORINTHDEV</strong>. All Rights Reserved
      </div>
      <div class="credits">
        <!--
        ...
        -->
        Designed by <a href="#!">CORINTHDEV</a>
      </div>
    </div>
  </footer><!-- #footer -->
